...
if(isRegisteredUser(user)){
  ...
  if(isValidEmail(user)){
    ...
    console.log(' email is not valid has to have one or more  chr before @perseverenow.org or .prsver@gmail.com')
    console.log('password is not valid has to be 8 or mor chr has to have 1 capital letter and 1 lower case letter')
    }
}
